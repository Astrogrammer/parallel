...
**Решение:** удалить файл `/home/user/.ssh/known_hosts` (или `C:\Users\user\.ssh\known_hosts`). При повторном входе ввести `yes`.  

**Ошибка:** Permission denied (publickey)
**Причина:** приватный ключ на клиенте не подходит к публичному ключу на сервере.  
    *Вариант 1:* неправильный ввод логина.  
    *Решение*: проверить, что команда имеет вид `ssh ivanov_ii@hpc.cs.vsu.ru` (НЕ Ivanov_ii, ivanov_i_i, ivanov_ivanivanovich).  
